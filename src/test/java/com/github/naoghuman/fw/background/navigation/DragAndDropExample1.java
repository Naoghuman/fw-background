 ...
 */
public class DragAndDropExample1 extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // ListView
        ListView<String> list = new ListView<>(FXCollections.observableArrayList("Single", "Double", "Suite", "Family App"));
