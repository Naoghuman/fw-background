 ...
 */
public final class ElementImage extends Element {
    ...
    public List<Node> getDetailsComponents() {
        ...
        nodes.add(new Label("Components for ElementImage -> Background"));
    ...
    public List<Node> getDetailsDescription() {
        final List<Node> nodes = FXCollections.observableArrayList();
        nodes.add(new Label("Description for ElementImage -> Palette"));
