 ...
 */
public final class ElementColor extends Element {
    ...
    public List<Node> getDetailsComponents() {
        ...
        nodes.add(new Label("Components for ElementColor -> Background"));
    ...
    public List<Node> getDetailsDescription() {
        final List<Node> nodes = FXCollections.observableArrayList();
        nodes.add(new Label("Description for ElementColor -> Palette"));
    ...
    public List<ElementType> getParentTypes() {
        final List<ElementType> parents = FXCollections.observableArrayList();
        parents.add(ElementType.BACKGROUND);
        parents.add(ElementType.IMAGE);
