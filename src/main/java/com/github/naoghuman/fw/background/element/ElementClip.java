 ...
 */
public final class ElementClip extends Element {
    ...
    public List<Node> getDetailsComponents() {
        ...
        nodes.add(new Label("Components for ElementClip -> Background"));
    ...
    public List<Node> getDetailsDescription() {
        final List<Node> nodes = FXCollections.observableArrayList();
        nodes.add(new Label("Description for ElementClip -> Palette"));
